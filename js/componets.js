...
navegacion.innerHTML = '<nav class="navbar navbar-expand-lg bg-light m-1"><div class="container-fluid"><a class="navbar-brand" href="index.html"><span class="icon-home" ></span> Home</a><button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"><span class="icon-menu3"></span></button><div class="collapse navbar-collapse" id="navbarNav"><ul class="navbar-nav"><li class="nav-item"><a class="nav-link " aria-current="page" href="contenido1.html">Ética y Deontología</a></li><li class="nav-item"><a class="nav-link" href="contenido2.html">Códigos de Conducta Ética</a></li><li class="nav-item"><a class="nav-link" href="contenido3.html">Códigos Deontológicos</a></li><li class="nav-item"><a class="nav-link" href="contenido4.html">Leyes, Normas, Reglamentos y Resoluciones</a></li><li class="nav-item"><a class="nav-link" href="contenido5.html">Casos Prácticos</a></li></ul></div></div></nav>';
